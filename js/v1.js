...
function obtener_casilla(col){
    ...
    for (let i = filas; i >= 1; i--) {
        ...
        //fila_actual.attr("data-fila", i); //Añadimos la fila como dato al div 
        //fila_actual.attr("data-columna", col); //Añadimos la columna como dato al div 
